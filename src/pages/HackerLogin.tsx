...
export default function HackerLogin() {
  ...
  const handleGoogleLogin = () => {
    console.log("Google login for hacker");
    // Handle Google OAuth
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">Hacker Login</CardTitle>
          <p className="text-muted-foreground">
            Sign in to your hacker account
          </p>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="text-center text-sm">
            ...
            <Link to="/hacker/signup" className="text-primary hover:underline">
              Sign up
            </Link>
          </div>
        </CardContent>
