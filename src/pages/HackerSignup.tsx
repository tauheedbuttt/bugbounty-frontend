      ...
      case "available":
        return (
          <p className="text-sm text-green-600">
            {t.common.buttons.username_is_available}
          </p>
        );
      case "taken":
        return (
          <p className="text-sm text-red-600">
            {t.common.buttons.username_is_already_taken}
          </p>
        );
      default:
        return null;
      ...
      <Card className="w-full max-w-md">
        ...
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">
            {t.common.buttons.create_hacker_account}
          </CardTitle>
          <p className="text-muted-foreground">
            {t.common.buttons.join_the_bug_bounty_community}
          </p>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="firstName"
                    placeholder={t.forms.labels.first_name}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="lastName"
                    placeholder={t.forms.labels.last_name}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="username"
                  placeholder={t.forms.placeholders.choose_username}
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm">
                {t.common.buttons.i_agree_to_the}{" "}
                <Link to="/terms" className="text-primary hover:underline">
                  {t.common.buttons.terms_of_service}
                </Link>{" "}
                {t.common.buttons.and}{" "}
            ...
            >
              {t.common.buttons.create_account}
            </Button>
          </form>

          {/* Login */}
          <div className="text-center text-sm">
            {t.common.buttons.already_have_account}{" "}
            <Link
