    ...
    <footer className="border-t border-gray-800 bg-black">
      <div className="container mx-auto px-4 py-6 sm:py-8">
              ...
              <div>
                ...
                <div className="space-y-3 text-sm font-light text-gray-300 ml-5">
                  <Link
                    ...
                    className="block hover:text-white cursor-pointer"
                  >
                    {t.common.buttons.report_manager}
                  </Link>
                  <Link
                    to={ROUTE_PATHS.DASHBOARD}
                    className="block hover:text-white cursor-pointer"
                  >
                    {t.common.buttons.analytics_dashboard}
                  </Link>
                  <Link
                    to={ROUTE_PATHS.DASHBOARD}
                    className="block hover:text-white cursor-pointer"
                  >
                    {t.common.buttons.live_monitoring}
                  </Link>
                </div>
              </div>
        ...
        <div className="text-center text-sm text-gray-500 mt-6 font-light">
          {t.forms.labels["2024_bugbounty_platform_all_rights"]}
        </div>
      </div>
    </footer>
  );
