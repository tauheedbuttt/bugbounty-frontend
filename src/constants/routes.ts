export const ROUTE_PATHS = {
  ...
  // Program
  PROGRAM_REPORTS: "/:programName/reports",
  PROGRAM_TRIAGERS: "/:programName/triagers",
  PROGRAM_ANALYTICS: "/:programName/analytics",
  PROGRAM_PAYMENTS: "/:programName/payments",
  PROGRAM_REPORT_DETAILS: "/:programName/report/:reportId",
